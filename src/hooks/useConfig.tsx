...
export function ConfigProvider({ children }: {
    ...
    const handleChangeLocation = useCallback((lang: string) => {
        setI18n(lang);
    }, []);

    const handleChangeMode = useCallback((isDark: boolean) => {
        setDarkMode(isDark);
    }, []);
    ...
    return (
        <ConfigContext.Provider value={{ i18n, darkMode, handleChangeLocation, handleChangeMode }}>
            {children}
